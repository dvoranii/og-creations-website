...
@Component({
  ...
  styleUrls: ['./home.component.css', './home.component.queries.css'],
})
export class HomeComponent implements OnInit, AfterViewInit {
  @ViewChild('recordingSection', { read: ElementRef }) recordingSection:
    | ElementRef
    | any;
  @ViewChild('mixingSection', { read: ElementRef }) mixingSection:
    | ElementRef
    | any;
  @ViewChild('ebookSection', { read: ElementRef }) ebookSection:
    | ElementRef
    | any;
